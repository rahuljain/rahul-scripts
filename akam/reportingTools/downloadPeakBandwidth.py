...
print ("Format: [cpcode, edge peak bandwidth (Mbits/s), origin peak bandwidth (Mbits/s)]")
#www.sears.com.xml
...
for cpcode in cpcodes:
  ...
  url = 'https://control.akamai.com/core-reports/services/traffic/bandwidth/cpcode/'+cpcode+'/ui.json?start_date=10%2F01%2F2013&end_date=10%2F08%2F2013&start_time=00%3A00&end_time=00%3A00&traffic_option=all&ipversion=all&max_points=870&time_zone=GMT&locale=en_US'
  r = ''
  try:
    r = br.open(url)
